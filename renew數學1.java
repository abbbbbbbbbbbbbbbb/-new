...
public class renew數學1 {
renew數學1(){
	//public static void main(String[] args) {
		new M1Frame().launchFrame();
	//}
}
class M1Frame extends Frame{
	TextField question,a,b,c,d,answer;
	Map<String,String> ppd = new HashMap();
	...
	private class Montitor2 implements ActionListener{
		public void actionPerformed(ActionEvent m) {
			String file = "C:\\Users\\Jacky\\Desktop\\MATH1.txt";
			try {
				FileWriter out = new FileWriter(file, true);
				out.write("\n&&"+"\n");
				out.write(String.valueOf(ppd));
				out.close();
			}catch (IOException e) {
				e.printStackTrace();
			}
